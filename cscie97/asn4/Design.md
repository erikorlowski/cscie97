...
These three classes extend the EntitlementException class, which is meant to be a catch-all for Entitlement Service related Exceptions. The EntitlementException class extends the Exception class to ensure that Exceptions generated by the Housemate Entitlement Service are handled explicitly.
